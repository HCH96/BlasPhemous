	...
	, m_pHitBox(nullptr)
{
	...
	m_pAnimator->SetAnimDuration(L"WalkBack", 0.08f);
	m_pAnimator->SetAnimDuration(L"WalkBack_L", 0.08f);
	...
	m_pAnimator->SetAnimDuration(L"Attack", 0.8f);
	...
	m_pAnimator->SetAnimDuration(L"Death", 0.8f);
